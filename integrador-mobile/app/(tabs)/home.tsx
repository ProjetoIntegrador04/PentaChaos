...
// ... (toda a parte de cima do seu código, com os dados e o componente, continua igual)
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingTop: 40,
    paddingBottom: 30, // AJUSTADO: Diminuído, pois não precisa de tanto espaço
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center', // AJUSTADO: Voltado para 'center'
  ...
  dashboardSection: {
    paddingHorizontal: 20,
    marginTop: 20, // AJUSTADO: Agora tem uma margem positiva para ficar ABAIXO do header
    // zIndex não é mais necessário
  },
  sectionTitle: {
    fontSize: 22,
    fontWeight: 'bold',
    color: '#333',   // AJUSTADO: Cor do texto para escuro, para ser visível no fundo claro
    marginBottom: 15,
  },
  squadCardsContainer: {
    paddingVertical: 10,
  ...
  integrantesButton: {
    ...
    alignItems: 'center',
    marginHorizontal: 80,
    marginTop: 30, // AJUSTADO: Margem positiva para ficar abaixo do card
    paddingVertical: 12,
    paddingHorizontal: 20,
    borderRadius: 30,
    shadowColor: "#000",
